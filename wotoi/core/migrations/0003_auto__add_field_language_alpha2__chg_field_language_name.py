...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Language.alpha2'
        db.add_column(u'core_language', 'alpha2',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Language.name'
        db.alter_column(u'core_language', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):
        # Deleting field 'Language.alpha2'
        db.delete_column(u'core_language', 'alpha2')


        # Changing field 'Language.name'
        db.alter_column(u'core_language', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=20))
